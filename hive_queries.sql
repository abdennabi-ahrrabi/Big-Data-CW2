...
-- ============================================
-- QUERIES FOR ZEPPELIN VISUALIZATION
-- ============================================

-- For Bar Chart: Top 15 Countries by PM2.5
-- SELECT country, avg_pm25 FROM pollution_mortality_analysis ORDER BY avg_pm25 DESC LIMIT 15;

-- For Bar Chart: Mortality Rates
-- SELECT country, mortality_rate FROM pollution_mortality_analysis ORDER BY mortality_rate DESC LIMIT 15;

-- For Pie Chart: AQI Distribution
-- SELECT aqi_category, COUNT(*) as count FROM air_quality GROUP BY aqi_category;

-- For Scatter Plot: PM2.5 vs Mortality
-- SELECT avg_pm25, mortality_rate, country FROM pollution_mortality_analysis;
